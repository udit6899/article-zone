...
@section('content')
    <form action="{{ route('author.post.update', $post) }}" method="POST" enctype="multipart/form-data">
        @method('PATCH')
        @csrf
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <a class="btn bg-deep-orange m-t-15 waves-effect" href="{{ route('author.post.index') }}">BACK</a>
