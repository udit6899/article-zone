                                ...
                                <div class="recent-post-content clearfix">
                                    ...
                                    <div class="recent-post-single single-page">
                                        <div class="recent-post-img single-page">
                                            <a href="{{ route('article.singleArticle', [ 'title' => $title ]) }}"><img src="{{ asset('images/recent-1.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="recent-post-text single-page">
                                            <span>01 jan, 2016</span>
                                            <a href="{{ route('article.singleArticle', [ 'title' => $title ]) }}"><p>celebration of new year</p></a>
                                        </div>
                                    </div>
                                    <div class="recent-post-single single-page">
                                        <div class="recent-post-img single-page">
                                            <a href="{{ route('article.singleArticle', [ 'title' => $title ]) }}"><img src="{{ asset('images/recent-2.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="recent-post-text single-page">
                                            <span>01 jan, 2016</span>
                                            <a href="{{ route('article.singleArticle', [ 'title' => $title ]) }}"><p>color in nature</p></a>
                                        </div>
                                    </div>
                                    <div class="recent-post-single single-page">
                                        <div class="recent-post-img single-page">
                                            <a href="{{ route('article.singleArticle', [ 'title' => $title ]) }}"><img src="{{ asset('images/recent-3.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="recent-post-text single-page">
                                            <span>01 jan, 2016</span>
                                            <a href="{{ route('article.singleArticle', [ 'title' => $title ]) }}"><p>yummy burgers</p></a>
                                        </div>
                                    </div>
                                </div>
